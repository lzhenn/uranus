...
smp_grid='/home/lzhenn/WRF-preprocess/WPS-4.1/geo_em.d01.nc'; % sample grid from wrf geogrid
roms_grid='/home/lzhenn/array74/Njord_Calypso/domaindb/s2s/roms_d01.nc'; % Call generic grid creation.

netcdf_load(smp_grid)
figure
pcolorjw(XLONG_M,XLAT_M,double(1-LANDMASK))
hold on
title('WRF LANDMASK grid, lambert proj')
...
% pick numbers, roms nrow x ncol, nWE: xi_rho; nSN eta_rho
% Lm= xi_rho-2; Mm = eta_rho-2
xi_rho = 510; eta_rho=310;
...
title('ROMS 1-LANDMASK grid, Lambert proj')
xlabel('longitude'); ylabel('latitiude')
